  ...
  log.info(
    {
      ...
      workflowKind: workflow.workflowKind,
      ...profileLogContext,
      usedSkillCommand: promptPolicy.usedSkillCommand,
      usedFallbackSkillCommand: promptPolicy.usedFallbackSkillCommand,
      usedFallbackSlashCommand: promptPolicy.usedFallbackSlashCommand,
      renderedSkillCommand: promptPolicy.renderedSkillCommand ?? null,
      suppressModelFallback,
      canResume,
    },
