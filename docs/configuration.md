...
| `CODEX_CLI_PATH`                   | string  | _(optional)_                   | Absolute path to the Codex CLI binary used by Codex CLI/App Server runtime adapters                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
- `CODEX_CLI_PATH` for Codex CLI/App Server transport adapters
